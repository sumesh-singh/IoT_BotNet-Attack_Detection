...
Implements LightGBM classifier with optimized hyperparameters for IoT botnet detection.
"""
...
class LightGBMModel:
    """LightGBM classifier optimized for IoT botnet detection."""
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"LightGBMModel initialized with params: {self.params}")
    ...
    def train(self, X: pd.DataFrame, y: pd.Series,
        ...
        logger.info(
            f"LightGBM training completed. Train accuracy: {train_score:.4f}")
    ...
    def get_training_curves(self) -> Dict[str, List[float]]:
        """Get training curves if available from LightGBM."""

        if not self.is_trained:
            return {}

        # LightGBM stores evaluation results if eval_set was provided
...
if __name__ == '__main__':
    ...
    print(lgb_model.get_feature_importance(10))

    # Model info
    print("\nModel Info:")
    print(lgb_model.get_model_info())
